...
export default function AboutMeCard() {
	return (
		<div className='flex flex-col items-center justify-center p-4 bg-neutral-800 rounded-2xl border border-white/25'>
			...
			<p className={`italic text-neutral-300 text-tiny tiny:text-xxs xxs:text-xs xs:text-sm sm:text-sm md:text-md text-center mt-5 font-normal ${montserrat.className}`}>Разработчик с 6-летним опытом самостоятельной работы над pet-проектами. Создавал игры, приложения и веб-сервисы с использованием Godot 4, Node.js, Next.js, PHP, TypeScript и Electron. Интересуюсь разработкой игр и современных веб-технологий, постоянно развиваю навыки и осваиваю новые инструменты</p>
			<br></br>
