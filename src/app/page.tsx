      ...
      <div className='container p-4 mx-auto mt-5 bg-neutral-800 rounded-2xl w-1/4 border border-white/25'>
        ...
        <div className='flex items-center justify-center gap-10'>
          <Link href={'https://github.com/qurs'} target='_blank'>
            <Image className='hover:drop-shadow-[0_0_8px_#a776b8aa]' src={'/github-mark-white.svg'} alt='' width={32} height={32} />
          </Link>
          <Link href={'https://t.me/vankuver11'} target='_blank'>
            <Image className='hover:drop-shadow-[0_0_8px_#a776b8aa]' src={'/telegram.svg'} alt='' width={32} height={32} />
          </Link>
        </div>
      </div>
      ...
      <div className='container p-5 pb-15 mx-auto mt-5 mb-5 bg-radial from-neutral-800 to-neutral-900/80 rounded-2xl w-3/4 border border-white/25'>
        ...
        <div className='grid lg:grid-cols-1 lg:grid-rows-3 xl:grid-cols-3 xl:grid-rows-1 mt-10 sm:gap-1 md:gap-1 lg:gap-5'>
          <WorkCard
            ...
            logo='/nationforge.png'
            logoSize={128}
            roles={['Разработчик игры']}
            stack={['Lua', 'Love2D', 'ImGui', 'Github CI/CD']}
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/new-strat'} ]}
          ...
          <WorkCard
            ...
            links={[ {img: '/discord.svg', url: 'https://discord.gg/KSxjfTYyTe'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/tria.su-nodejs'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/triabot'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            roles={['Основатель проекта', 'Главный разработчик', 'Системный администратор', 'Руководитель сообщества']}
            stack={['Lua', 'Garry\'s Mod', 'Docker', 'MySQL']}
            links={[ {img: '/discord.svg', url: 'https://discord.gg/49yDHxKDWz'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            logo='/discord_jamspace.png'
            roles={['Автор идеи и разработчик', 'Организатор игрового процесса']}
            stack={['Lua', 'Luvit', 'TCP']}
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/jamspace-strategy'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            logo='/hammerpp_manager.png'
            logoSize={64}
            roles={['Разработчик приложения', 'Дизайнер интерфейса']}
            stack={['Electron', 'JavaScript', 'HTML', 'CSS']}
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/hammerpp-manager'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            logo='/pretty_commits.png'
            logoSize={64}
            roles={['Разработчик сервиса']}
            stack={['Node.JS', 'JavaScript', 'Docker']}
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/pretty-commits'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            stack={['Love2D', 'Lua']}
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/gofishing'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            logo='/qmc_launcher.png'
            logoSize={64}
            roles={['Разработчик лаунчера', 'Разработчик бекэнда']}
            stack={['Lua', 'LuaJIT', 'HTTP']}
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/mc-launcher'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
          ...
          <WorkCard
            ...
            links={[ {img: '/github-mark-white.svg', url: 'https://github.com/qurs/sc-bot'} ]}
            setModalActive={setModalActive}
            setModalData={setModalData}
          />
        </div>
